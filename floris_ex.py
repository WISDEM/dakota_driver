...
if __name__ == "__main__":
   ...
   # initialize input variable arrays
    ...
    if not opting:
     ...
     prob.driver.max_iterations = 100
     ...
     # by stdMult
     prob.driver.population_size = 800
     prob.driver.meanMult = 1. 
     #prob.driver.dakota_hotstart = True
     #prob.driver.n_sub_samples = 100
     prob.driver.stdMult = 1. 
     prob.driver.fd_gradient_step_size = 1e-2
     prob.driver.add_method('soga', method_options = {'max_iterations':2, 'population_size':2}, model='nested')
     prob.driver.add_method(response_type='r', model='single', method='sampling', method_options = {'samples':2})
     #prob.driver.Optimization(opt_type='moga', ouu=1, compromise = False, sub_sample_type='polynomial_chaos')
