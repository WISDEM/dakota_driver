...
@add_delegate(HasParameters, HasObjectives,HasIneqConstraints)
...
###########################################################
    ...
    def DakotaCONMIN(self):
        ...
        self.__class__.configure_input=configure_input


    def DakotaMultidimStudy(self):
